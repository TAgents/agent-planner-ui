...
const AppSidebar: React.FC<AppSidebarProps> = ({ className = '', variant = 'full' }) => {
  ...
  return (
    <aside
      className={`w-64 h-screen flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 ${className}`}
    >
      {/* Header */}
